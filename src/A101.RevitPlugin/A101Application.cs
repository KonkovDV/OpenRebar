...
/// <summary>
/// Registers the A101 ribbon tab and command button in Revit.
/// </summary>
public sealed class A101Application : IExternalApplication
{
    private const string TabName = "A101";
    ...
    public Result OnStartup(UIControlledApplication application)
    {
        ...
        if (pushButton is not null)
        {
            ...
            var iconPath = Path.Combine(
                Path.GetDirectoryName(typeof(A101Application).Assembly.Location) ?? string.Empty,
                "Resources",
                "icon-32.png");
...
#else
internal static class A101ApplicationPlaceholder
{
