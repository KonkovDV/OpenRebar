...
public class FullPipelineIntegrationTests
{
    ...
    {
        var tempDirectory = Path.Combine(Path.GetTempPath(), $"a101-e2e-{Guid.NewGuid():N}");
        ...
        try
        {
            ...
            result.Report!.ContractId.Should().Be("a101.reinforcement.report.v1");
            ...
            persistedReport.Should().Contain("\"contractId\": \"a101.reinforcement.report.v1\"");
